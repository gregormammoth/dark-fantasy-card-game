...
export const metadata: Metadata = {
  title: 'Cards',
  description: 'Player cards available in the current Hollowfort content pack.',
};

export default function CardsPage() {
  const cards = (playerCards as CardDefinition[]).filter((card) => Boolean(card.class));
  ...
  return (
    <PageShell>
      <PageHero
        eyebrow="ARSENAL"
        title="Cards"
        description="Data-driven from the game content pack — add cards in JSON without changing site code."
      />
